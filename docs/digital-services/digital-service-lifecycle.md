...
There may also be incidents, such as service outages and data breaches occurring while the service is running and also requests
...
![Figure 1](digital-service-lifecycle-stages.png#pagewidth)
...
![Figure 2](digital-service-lifecycle-stages-with-metadata-repository.png#pagewidth)
